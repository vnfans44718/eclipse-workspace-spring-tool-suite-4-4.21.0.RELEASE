...
Guest updateGuest = Guest.builder().guestNo(Integer.parseInt(noStr)).guestName(gName).guestEmail(gEmail)
		.guestHomepage(gHomepage).guestTitle(gTitle).guestContent(gContent).build();
