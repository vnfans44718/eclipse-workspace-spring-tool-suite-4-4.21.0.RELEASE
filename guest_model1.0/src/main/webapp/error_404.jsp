...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link rel="stylesheet" type="text/css"
		href="https://www.naver.com/resources/css/err_170424.css">
...
<body>
	...
	<div id="wrap">
		<div id="header">
			...
			<p class="menu">
				<a href="http://www.naver.com/">네이버홈</a> | <a
					href="http://help.naver.com/">네이버 고객센터</a>
			</p>
		</div>
		<div id="container">
			<h2>
			...
			<div class="content">
				...
				<p>
					관련 문의사항은 <a href="http://help.naver.com/">네이버 고객센터</a>에 알려주시면 친절하게
					안내해 드리겠습니다.
				</p>
				<p>감사합니다.</p>
			</div>
			<form class="search" style="margin-top: 50px;" name="search"
				...
				<input type="hidden" name="sm" value="nnf_hty">
					<fieldset class="window02">
						<legend>검색</legend>
						<input type="text" title="검색" name="query" maxlength="255"
							value="" class="box_window" accesskey="s"> <input
		...
		<div id="footer">
			<address>
				<a href="http://www.nhncorp.com/" target="_blank" class="logo"><img
					src="https://s.pstatic.net/static/common/footer/logo_naver.gif"
					width="63" height="15" alt="NAVER"></a> <em>Copyright ©</em> <a
					href="http://www.nhncorp.com/" target="_blank">NAVER Corp.</a> <span>All
